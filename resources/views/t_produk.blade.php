            ...
            <div class="page-header">
                  ...
                  @if(Auth::user()->hasAnyRole(['owner', 'admin']))
                        <nav aria-label="breadcrumb">
                              <div class="btn-group">
                                    <a href="/stok" class="btn btn-gradient-info text-white shadow-sm ms-2"><i
                                                class="mdi mdi-package-variant"></i> Daftar Stok</a>
                              </div>
                        </nav>
                  @endif
            </div>
                                                ...
                                                <tbody>
                                                      @foreach ($produk as $data)
                                                            <tr>
                                                                  ...
                                                                  <td>
                                                                        <span
                                                                              class="badge {{ $data->kategori == 'Makanan' ? 'bg-gradient-info' : 'bg-gradient-success' }}">
                                                                              {{ $data->kategori }}
                                                                        </span>
                                                                  </td>
                                                                  @if(Auth::user()->hasAnyRole(['owner', 'admin']))
