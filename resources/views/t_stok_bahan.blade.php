      ...
      <div class="content-wrapper">
        <div class="page-header">
          ...
          <nav aria-label="breadcrumb">
            <button type="button" class="btn bg-gradient-primary text-white" data-bs-toggle="modal" data-bs-target="#addBahanModal">
                  + Bahan Baru
            </button>
          </nav>
        </div>
        ...
        <div class="row">
          <div class="col-12 grid-margin">
            <div class="card shadow p-3 mb-5 bg-body rounded">
              <div class="card-body">
                <h4 class="card-title text-primary"><i class="mdi mdi-format-list-bulleted"></i> Daftar Stok Bahan Baku</h4>
                  ...
                  <table class="table table-bordered" id="mytable">
                        ...
                        @foreach ($bahan as $data)
                              <tr>
                                    ...
                                    <td>{{ $data->satuan }}</td>
                                    <td>
                                          <a href="/stok/bahan/delete/{{ $data->id_stok }}" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus bahan ini? Ini mungkin merusak resep menu yang sudah ada.')"><i class="mdi mdi-delete"></i></a>
                                    </td>
                              </tr>
                        @endforeach
                        </tbody>
          ...
          <div class="modal-content">
            <form action="/stok/bahan/insert" method="POST">
                  ...
                  <div class="mb-3">
                        ...
                        <input type="text" name="nama_stok" class="form-control" placeholder="Contoh: Minyak Goreng, Beras, Telur" required>
                  </div>
                  <div class="mb-3">
