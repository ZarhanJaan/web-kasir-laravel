...
<head>
    <title>Daftar — Toko Sembako Lina</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="Daftar akun baru di sistem kasir Toko Sembako Lina">
...
<body>
            ...
            <form method="POST" action="{{ route('register') }}" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <button type="button" class="password-toggle" id="toggleConfirmPassword" aria-label="Tampilkan password">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
    ...
    <script>
        ...
        setupPasswordToggle('toggleConfirmPassword', 'password-confirm', 'eyeIconConfirm');
    </script>
