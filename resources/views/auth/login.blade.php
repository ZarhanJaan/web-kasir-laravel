			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form method="POST" action="{{ route('login') }}" class="login100-form validate-form" >
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<input id="email" placeholder="Type your email" type="email" class="input100 form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						...
						<input id="password" placeholder="Type your password" type="password" class="input100 form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
