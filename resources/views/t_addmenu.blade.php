      ...
      <div class="content-wrapper">
        ...
        <form action="/menu/insert" method="POST">
            ...
            <div class="col-12 col-md-6">
                        ...
                        <input name="id_menu" class="form-control" value="{{ old('id_menu') }}">
                        ...
                        <input name="nama_menu" class="form-control" value="{{ old('nama_menu') }}">
                        <div class="text-danger">
                              @error('nama_menu')
                                  {{ $message }}
                              @enderror
                        ...
                        <input type="number" name="harga_menu" class="form-control" value="{{ old('harga_menu') }}">
                        <div class="text-danger">
                              @error('harga_menu')
                                  {{ $message }}
                              @enderror
            ...
            <div class="row">
                  <div class="col-12 col-md-6">
                        <button class="btr btn bg-gradient-info text-white">Simpan Menu</button>
                  </div>
            </div>
        </form>
